...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/jpa_basic?useUnicode=true&characterEncoding=UTF-8");
        dataSource.setUsername( "huuphuc0261993" );
        dataSource.setPassword( "Cccv0103@" );
        return dataSource;
    }
